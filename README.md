...
The generator (`RAG/QA_generator.py`) suck my weenus. 


TODO: finish this 
- The **generator** (`QA_generator.py`) enriches responses with retrieved knowledge.  
- Output can be structured in different formats (default: **Q&A pairs**).  
